...
class AppStore extends Component {
  ...
  onTabChange = currentTabId => this.setState({activeTabId: currentTabId})
  ...
  render() {
    ...
    const searchResults = filteredAppsList.filter(eachAppItem =>
        ...
        <div className="app-card">
          ...
          <ul className="app-list-container">
            {searchResults.map(eachAppItem => (
              <AppItem eachAppItem={eachAppItem} key={eachAppItem.appId} />
            ))}
          </ul>
        </div>
      </div>
